...
function criaCardPokemon(id){
    var card = `
        ...
        <div class="pokemon_attributes">
            <div class="attribute">
                <span class="pokemon_height" id="pokemon_height${id}"></span>
                <spanp>height</spanp>
            </div>
            <div class="attribute">
                <span class="pokemon_weight" id="pokemon_weight${id}"></span>
                <spanp>weight</spanp>
            </div>
            <div class="attribute">
                <span class="pokemon_abilities" id="pokemon_abilities${id}"></span>
                <span>abilities</span>
            </div>
        </div>
    `
